...
$select_chech = mysqli_query($con, "SELECT * FROM father_tbl WHERE email='".trim($_POST['email'])."' OR phonenumber='".trim($_POST['phonenumber'])."'");
// uplading Thumbnail
if ($img_size > 2250000) {
...
elseif ($password != $cpass) {
  ...
  if (in_array($img_ex_lc, $allowed_exs)) {
      ...
      $query=mysqli_query($con,"INSERT INTO `father_tbl`(`firstname`, `lastname`, `email`, `phonenumber`, `password`, `ImageName`, `status`) 
      VALUES ('$firstname','$lastname','$email','$phonenumber','$hashpassword','$new_img_name','$status')");

          if($query)
          {
            echo '<script>alert("New Father User is Created successfully ")</script>';
...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Home</a><i class="fa fa-angle-right"></i>Father<i class="fa fa-angle-right"></i> Father Add</li>
</ol>
<!--grid-->
<center>
