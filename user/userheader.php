   ...
   <body class="size-1140">
      ...
      <header>
         <nav>
            <div class="line">
               <div class="s-12 l-5">
                  <h3 style="color: white;">RCMA</h3>
               </div>
               <div class="top-nav s-12 l-3 right">
                  <div class="employee-name" style="margin-top: 13%;">
                  <a style="color: white;">User <font color="#808B96">:</font> <?php echo $_SESSION['firstname']; ?></a> |
               ...
               <aside class="s-12 l-2">
                  <div class="aside-nav">
                     <ul>
                        ...
                        <li>
                           <a title="Leave">Anouncement</a>
                           <ul>
                              <li><a href="add_anouncement.php">Add Anouncement</a></li>
                              <li><a href="view_anouncement.php">View Anouncement</a></li>
                           </ul>
                        </li>
                        <li>
                        <li>
                           <a title="Leave">Certificate</a>
                           <ul>
                        ...
                        <li>
                           <a title="Leave">Request Christian </a>
                           <ul>
                              <li><a href="applyleave.php">Verify Request</a></li>
                              <li><a href="leavestatus.php">Rejected Request</a></li>
                           </ul>
                        </li>
                        <li>
                           <a title="LeaveS">Payment</a>
                           <ul>
                              <li><a href="applyleave.php">Approve</a></li>
                              <li><a href="leavestatus.php">Rejected</a></li>
                           </ul>
                        </li>
                        <li>
                           <a title="Leave">Report</a>
                           <ul>
                              <li><a href="applyleave.php">Approved</a></li>
                              <li><a href="leavestatus.php">Rejected</a></li>
                           </ul>
                        </li>
                        <li><a href="changepassword.php" title="Change Password">Change Password</a></li>
                     </ul>
                  </div>
               </aside>
               <!-- CONTENT -->