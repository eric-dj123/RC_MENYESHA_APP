...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Home</a><i class="fa fa-angle-right"></i>Receptionist<i class="fa fa-angle-right"></i> Christian Add</li>
</ol>
...
<div class="card-tools" style="float: right;">
                    <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#addsector" ><i class="fas fa-plus" ></i> Upload Csv File
                    </button>
                  </div>  
 	...
 	<!---->
        ...
        <div class="vali-form-group">
          <div class="col-md-4 control-label">
              <label class="control-label">Christian FullName</label>
            ...
            <div class="vali-form-group">
          <div class="col-md-4 control-label">
              <label class="control-label">Parre/marrene Fullname</label>
              <div class="input-group">             
                  <span class="input-group-addon">
              <i class="fa fa-user" aria-hidden="true"></i>
              </span>
            ...
            <div class="clearfix"> </div>
            <div class="col-md-4 control-label">
              <label class="control-label">Parre/marrene Phone*</label>
              <div class="input-group">             
                  <span class="input-group-addon">
